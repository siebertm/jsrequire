...
describe "JsRequire" do
  ...
  describe "#resolve_dependencies" do
    ...
    it "throw an exception when requiring a non existing file" do
      assert_raises JsRequire::FileNotFoundInLoadpath do
        assert_requires("require_non_existing_file.js", [])
      end
    end

    it "be able to require a file via namespaces" do
      assert_requires("require_namespaced_file.js", "namespace/a.js")
    end

    it "be able to require a file via relative namespaces" do
    ...
    it "be able to require a file with dots in filename" do
      assert_requires("require_filename_with_dot.js", "file.with.dot.js")
    end

    it "be able to require namespaced files starting with 'js'" do
      assert_requires("require_filename_with_js.js", "namespace/json_reader.js")
    end

    it "check loadpaths" do
